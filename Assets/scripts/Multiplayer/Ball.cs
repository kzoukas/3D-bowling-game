...
public class Ball : MonoBehaviour {
	...
	private bool ball_is_thrown;
	public Slider ballPowerSlider;
	public int round;
	public Pins[] pins;
	public Image player1_turn;
	public Image player2_turn;
	...
	public void Resets(){
		if (round % 2 == 0) {
			...
			if (player1_turn.color == Color.red) {
				player1_turn.color = Color.white;
				player2_turn.color = Color.red;

			} else {
				player1_turn.color = Color.red;
				player2_turn.color = Color.white;
			}
		}
	}
